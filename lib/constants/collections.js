...
export const COLLECTIONS = {
  ...
  research: {
    key: "research",
    title: "Research",
    description: "Research notes, references, studies, analysis, and structured knowledge development.",
    route: "/research",
    contentDir: "research",
    group: "Engineering",
    schemaType: "Article",
  ...
  music: {
    key: "music",
    title: "Music",
    description: "Soundtrack concepts, musical lore, civilization themes, and audio identity archives.",
    route: "/music",
    contentDir: "music",
    group: "Worldbuilding",
    schemaType: "Article",
  ...
  video: {
    key: "video",
    title: "Video",
    description: "Video concepts, cinematic prompts, visual direction, trailers, and media production archives.",
    route: "/video",
    contentDir: "video",
    group: "Worldbuilding",
    schemaType: "Article",
