...
export default function Chapters() {
  ...
  return (
    <div className="p-5 bg-slate-100">
      ...
      <p className="mb-4 text-center font-bold">Explore the chapters of Asthortera, a complex, layered, and deeply intertwined story that shape Asthortera’s destiny.</p>
