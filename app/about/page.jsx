...
export default function About() {
  return (
    <div className="editorial-shell py-10 text-slate-200">
      ...
      <section className="surface-card mb-12 p-6 sm:p-8">
        ...
        <ul className="list-disc list-inside text-slate-200 space-y-2 mb-4">
          <li>
            <strong className="text-white">Light read (1–2 min):</strong> Read the first two sections, then stop.
          </li>
          <li>
            <strong className="text-white">Professional context (3–5 min):</strong> Read until “Who It’s For”.
          </li>
          <li>
            <strong className="text-white">Deep alignment (optional):</strong> Read the full page.
          </li>
        </ul>
  ...
  <Heading className="text-left">About Reltroner Studio</Heading>
      ...
      <p className="mt-4 text-md text-slate-300 italic">
      ...
      <p className="mt-6 text-lg text-slate-200 leading-relaxed">
        <strong className="text-white">Reltroner Studio</strong> is a creative–technology studio built at
        the intersection of <strong className="text-white">system thinking</strong>,{" "}
        <strong className="text-white">digital engineering</strong>, and{" "}
        <strong className="text-white">storytelling</strong>.
      </p>
      ...
      <p className="mt-4 text-lg text-slate-200 leading-relaxed">
        ...
        <strong className="text-white">structured systems</strong>,{" "}
        <strong className="text-white">practical tools</strong>, and{" "}
        <strong className="text-white">meaningful narratives</strong> that help people and organizations
        move forward.
      </p>
      ...
      <ul className="mt-4 list-disc list-inside text-lg text-slate-200 leading-relaxed space-y-2">
        <li>
          <strong className="text-white">Digital systems and tools</strong> — SaaS prototypes, HR
          systems, internal tools, and automation-ready platforms.
        </li>
        <li>
          <strong className="text-white">Technical architectures</strong> — modular systems, API-based
          thinking, and scalable foundations.
        </li>
        <li>
          <strong className="text-white">Narrative-driven documentation</strong> — clear explanations
          of how problems are solved under real constraints.
        </li>
        <li>
          <strong className="text-white">Creative frameworks</strong> — translating abstract ideas into
      ...
      <p className="mt-4 text-lg text-slate-200 leading-relaxed">
        <strong className="text-white">Reltroner Studio connects both.</strong>
      </p>
      ...
      <p className="mt-4 text-lg text-slate-200 leading-relaxed">
        ...
        <strong className="text-white">system-architect mindset disguised as a creative studio</strong>{" "}
      ...
      <p className="mt-4 text-lg text-slate-200 leading-relaxed italic">
